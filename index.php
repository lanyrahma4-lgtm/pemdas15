<?php 
// --- WAJIB: Memanggil konfigurasi base URL ---
include('config.php'); 
?>
<!DOCTYPE html>
<html lang="id">
        ...
        <div class="search-section">
            <div class="container">
                ...
                <div class="search-box">
                    ...
                    <?php
                        // Contoh sederhana menampilkan keyword pencarian
        ...
        <div class="container book-container-wrapper">
            <div class="book-grid" id="book-grid">
                ...
                foreach ($books as $book) {
                    ...
                    // PATH GAMBAR DIPERBAIKI MENGGUNAKAN $base_url
                    echo '<img src="' . $base_url . '/' . htmlspecialchars($book['image']) . '" alt="Sampul Buku ' . htmlspecialchars($book['title']) . '">';
